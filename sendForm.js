...
function addTask(e) {
    ...
    console.log(courseNameText, sectionText);
                ...
                <div class="mainBlock_block">
                    ...
                    <div class="block_down">
                        <div class="block_downIco">
                            <div class="downIco1">
                                <svg class="icon_block" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13 5C13 4.44772 13.4477 4 14 4H19C19.5523 4 20 4.44772 20 5V18H22C22.5523 18 23 18.4477 23 19C23 19.5523 22.5523 20 22 20H19H14H10H5H2C1.44772 20 1 19.5523 1 19C1 18.4477 1.44772 18 2 18H4V12C4 11.4477 4.44772 11 5 11H10C10.5523 11 11 11.4477 11 12V18H13V5ZM15 18H18V6H15V18ZM9 18V13H6V18H9Z" fill="#000000"/>
                                </svg>
                            </div>
